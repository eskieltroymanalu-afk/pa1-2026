...
<section id="sejarah" class="section">
    <div class="container">
        ...
        <div class="sejarah-item">
            <div class="sejarah-image"><img src="/image/A5.jpeg"></div>
        ...
        <div class="sejarah-item reverse">
            <div class="sejarah-image"><img src="/image/A3.jpeg"></div>
            <div class="sejarah-text">
        ...
        <div class="sejarah-item">
            <div class="sejarah-image"><img src="/image/A4.jpeg"></div>
            <div class="sejarah-text">
...
<section id="umkm" class="section bg-light">
    <div class="container">
        ...
        <div class="grid-3">
            <div class="card">
                <img src="/image/papan.jpg" class="card-img">
            ...
            <div class="card">
                <img src="/image/DSC_0106.jpg" class="card-img">
                <div class="card-content">
                    <h3>Anyaman Bambu</h3>
...
<section id="penginapan" class="section">
    <div class="container">
        ...
        <div class="grid-3">
            <div class="card">
                <img src="/image/putih.jpg" class="card-img">
                <div class="card-content">
            ...
            <div class="card">
                <img src="/image/HomeStaySampuran.png" class="card-img">
                <div class="card-content">
